...
public class Utility
{
	 ...
	 */
	@NotNull
	public static Inventory copyInventory(@NotNull Inventory inventory, Component newTitle)
	{
	...
	/**
	 * Gets the associated emoji for the given enchantment.
	 *
	 * @param enchantment The enchantment to get the emoji for
	 * @return The emoji for the enchantment
	 */
	public static String getEmoji(Enchantment enchantment)
	{
	...
	/**
	 * Gets the associated emoji for the given attribute.
	 *
	 * @param attribute The attribute to get the emoji for
	 * @return The emoji for the attribute
	 */
	public static String getEmoji(Attribute attribute)
	{
		return switch (attribute.getKey().getKey().toLowerCase())
		{
			default -> "⚙"; // ⚙
		};
	}
	...
	/**
	 * Checks if the item is similar to any of the items in the list.
	 *
	 * @param currentItems The list of items to check against
	 * @param item The item to check
	 * @return true if the item is similar to any of the items in the list, false otherwise
	 */
	public static boolean isItemSimilar(@NotNull ArrayList<ItemStack> currentItems, ItemStack item)
	{
		for (ItemStack currentItem : currentItems)
		{
			if (currentItem == null && item == null) return true;
			else if (currentItem != null && item != null && currentItem.isSimilar(item)) return true;
		}
		return false;
	}

	/**
	 * Gets the first index of the item in the list, ignoring stack count.
	 *
	 ...
	 */
	public static int getFirstSimilarIndex(ArrayList<ItemStack> items, ItemStack search)
	{
		for (int i = 0; i < items.size(); i++)
		{
			if (items.get(i).isSimilar(search)) return i;
		}
		return -1;
	}
