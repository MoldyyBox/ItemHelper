...
public class BurningTimeAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Burning Time", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "burning_time_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.BURNING_TIME_ATTRIBUTE_MODEL_DATA;
	}
}
