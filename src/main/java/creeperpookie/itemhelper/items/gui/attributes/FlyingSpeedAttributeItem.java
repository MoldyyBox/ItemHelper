...
public class FlyingSpeedAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Flying Speed", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "flying_speed_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.FLYING_SPEED_ATTRIBUTE_MODEL_DATA;
	}
}
