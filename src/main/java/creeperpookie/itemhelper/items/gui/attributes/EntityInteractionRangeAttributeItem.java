...
public class EntityInteractionRangeAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Entity Interaction Range", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "entity_interaction_range_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.ENTITY_INTERACTION_RANGE_ATTRIBUTE_MODEL_DATA;
	}
}
