...
public class OxygenBonusAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Oxygen Efficiency", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "oxygen_bonus_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.OXYGEN_BONUS_ATTRIBUTE_MODEL_DATA;
	}
}
