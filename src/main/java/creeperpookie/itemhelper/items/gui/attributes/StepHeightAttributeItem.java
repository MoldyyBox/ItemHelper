...
public class StepHeightAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Step Height", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "step_height_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.STEP_HEIGHT_ATTRIBUTE_MODEL_DATA;
	}
}
