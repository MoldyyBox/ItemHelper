...
public class MaxHealthAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		{
			meta.addCustomEffect(new PotionEffect(PotionEffectType.INSTANT_HEALTH, 30 * 20, 0), true);
			meta.setCustomModelData(getModelData());
			meta.displayName(Component.text("Max Healing", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return ItemConstants.MAX_HEALTH_ATTRIBUTE_MODEL_DATA;
	}
}
