...
public class BlockInteractionRangeAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Block Interaction Range", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "block_interaction_range_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.BLOCK_INTERACTION_RANGE_ATTRIBUTE_MODEL_DATA;
	}
}
