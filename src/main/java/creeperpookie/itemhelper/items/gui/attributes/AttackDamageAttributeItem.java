...
public class AttackDamageAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Attack Damage", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "attack_damage_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.ATTACK_DAMAGE_ATTRIBUTE_MODEL_DATA;
	}
}
