...
public class WaterMovementEfficiencyAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Water Movement Efficiency", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "water_movement_efficiency_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.WATER_MOVEMENT_EFFICIENCY_ATTRIBUTE_MODEL_DATA;
	}
}
