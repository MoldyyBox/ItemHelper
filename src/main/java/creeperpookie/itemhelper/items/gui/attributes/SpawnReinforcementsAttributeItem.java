...
public class SpawnReinforcementsAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Spawn Reinforcements", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "spawn_reinforcements_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.SPAWN_REINFORCEMENTS_ATTRIBUTE_MODEL_DATA;
	}
}
