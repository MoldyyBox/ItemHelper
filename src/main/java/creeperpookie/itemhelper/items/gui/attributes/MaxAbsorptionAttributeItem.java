...
public class MaxAbsorptionAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Max Absorption", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "max_absorption_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.MAX_ABSORPTION_ATTRIBUTE_MODEL_DATA;
	}
}
