...
public class ArmorToughnessAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Armor Toughness", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "armor_toughness_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.ARMOR_TOUGHNESS_ATTRIBUTE_MODEL_DATA;
	}
}
