...
public class AttackKnockbackAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Attack Knockback", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "attack_knockback_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.ATTACK_KNOCKBACK_ATTRIBUTE_MODEL_DATA;
	}
}
