...
public class AttackSpeedAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Attack Speed", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "attack_speed_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.ATTACK_SPEED_ATTRIBUTE_MODEL_DATA;
	}
}
