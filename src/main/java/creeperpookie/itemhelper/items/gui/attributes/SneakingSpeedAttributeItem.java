...
public class SneakingSpeedAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Sneaking Speed", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "sneaking_speed_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.SNEAKING_SPEED_ATTRIBUTE_MODEL_DATA;
	}
}
