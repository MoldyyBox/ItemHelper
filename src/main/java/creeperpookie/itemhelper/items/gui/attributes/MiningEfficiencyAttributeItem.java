...
public class MiningEfficiencyAttributeItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Mining Efficiency", DefaultTextColor.DARK_AQUA).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "mining_efficiency_attribute";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.MINING_EFFICIENCY_ATTRIBUTE_MODEL_DATA;
	}
}
