...
public class CustomEnchantmentLevelItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Custom Level", DefaultTextColor.LIGHT_PURPLE).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return "custom_enchantment_level";
	}

	@Override
	public int getModelData()
	{
		return ItemConstants.CUSTOM_ENCHANTMENT_LEVEL_MODEL_DATA;
	}
