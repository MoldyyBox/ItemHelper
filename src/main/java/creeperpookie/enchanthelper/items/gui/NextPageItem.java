...
public class NextPageItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Next Page", DefaultTextColor.GREEN).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
	...
	{
		return ItemConstants.NEXT_PAGE_MODEL_DATA;
	}
}
