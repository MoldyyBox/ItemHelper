package creeperpookie.enchanthelper.items.gui;
...
public class PreviousPageItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(meta ->
		{
			...
			meta.displayName(Component.text("Previous Page", DefaultTextColor.GREEN).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
	...
	{
		return ItemConstants.PREVIOUS_PAGE_MODEL_DATA;
	}
}
