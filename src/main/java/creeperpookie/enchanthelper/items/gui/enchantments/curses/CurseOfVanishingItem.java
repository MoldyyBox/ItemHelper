package creeperpookie.enchanthelper.items.gui.enchantments.curses;
...
public class CurseOfVanishingItem implements CustomItem
{
	@Override
	@NotNull
	public ItemStack getItemStack()
	{
		...
		item.editMeta(Damageable.class, meta ->
		{
			...
			meta.displayName(Component.text("Curse of Vanishing", DefaultTextColor.RED).decoration(TextDecoration.ITALIC, false).decorate(TextDecoration.BOLD));
			meta.lore(List.of());
		});
	...
	{
		return ItemConstants.CURSE_OF_VANISHING_MODEL_DATA;
	}
